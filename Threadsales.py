...
def color_count(color):
  x = thread_sold_split.count(color)
  return x
...
for i in range(len(daily_transactions)):
  transaction = daily_transactions[i].split("***")
...
for i in range(len(colors)):
  xcount = color_count(colors[i])
  color = colors[i]
  msg = ("Thread Shed sold {xcount} threads of {color} thread today").format(xcount=xcount, color=color)
  print(msg)